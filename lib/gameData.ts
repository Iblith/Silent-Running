...
export const NPC_STATS: Record<string,{
  ...
  pirate_crew:{
    name:"Pirate Crew",type:"MINION",species:"Various",career:"Pirate",
    ...
    weapons:[
      ...
      {name:"Heavy Blaster Pistol",damage:"7",critical:3,range:"Medium",qualities:"Stun Setting"},
      {name:"Vibroknife",damage:"Brawn+1 (3)",critical:2,range:"Engaged",qualities:"Pierce 2, Vicious 1"},
    ],
    abilities:["Group Only — skills listed are group skills used when operating as a minion group"],
    equipment:"Blaster carbine, heavy blaster pistol, vibroknife, padded armour (+2 Soak), flight suit",
    desc:"Rank-and-file spacers turned pirate. Dangerous in numbers, unreliable under pressure. Individually easy to scatter; collectively capable of operating a starship or overwhelming a crew.",
    hook:"Pirate crews follow whoever is strongest. Defeat their leader credibly and they may switch sides — or scatter entirely.",
  },
  pirate_captain:{
    name:"Pirate Captain",type:"NEMESIS",species:"Human",career:"Pirate",
    brawn:4,agility:4,intellect:2,cunning:3,willpower:2,presence:3,
    soak:5,woundThreshold:20,strainThreshold:15,
    defense:{ranged:1,melee:1},
    skills:[{name:"Coercion",rank:3},{name:"Cool",rank:3},{name:"Coordination",rank:2},{name:"Deception",rank:3},{name:"Gunnery",rank:2},{name:"Leadership",rank:2},{name:"Melee",rank:4},{name:"Ranged (Heavy)",rank:3},{name:"Resilience",rank:2},{name:"Skulduggery",rank:3},{name:"Piloting (Space)",rank:3},{name:"Mechanics",rank:1}],
    talents:[
      {name:"Adversary 2",desc:"Upgrade the difficulty of all combat checks targeting this character twice."},
      {name:"Fearsome",desc:"At the start of combat, all opponents must make an Average Fear check."},
      {name:"Lethal Blows 1",desc:"Add +10 to Critical Injury results inflicted on opponents."},
      {name:"Toughened 2",desc:"Gain +4 Wound Threshold."},
    ],
    weapons:[
      {name:"Heavy Blaster Rifle",damage:"10",critical:3,range:"Long",qualities:"Auto-Fire, Cumbersome 3"},
      {name:"Vibro-Ax",damage:"Brawn+3 (7)",critical:2,range:"Engaged",qualities:"Pierce 2, Sunder, Vicious 3"},
    ],
    abilities:["Rally the Crew — once per round may call out orders; all pirate crew minion groups within medium range add a boost to their next check","Notorious — characters who recognise this pirate captain suffer setback on social checks to intimidate or deceive them"],
    equipment:"Heavy blaster rifle, vibro-ax, armoured coat (Soak +1, Def +1), encrypted comlink, ship access codes",
    desc:"A pirate captain who has survived the spacelanes long enough to become genuinely dangerous. Part strategist, part brawler, entirely unpredictable.",
    hook:"Their ship and crew are their power base. Strip those away and they become desperate — and desperation makes them either a threat or an asset.",
  },
  tie_pilot:{
    name:"TIE Pilot",type:"MINION",species:"Human",career:"Imperial Pilot",
    ...
    abilities:["Group Only — Gunnery and Piloting (Space) are group skills","Flight Suit — provides life support for 10 minutes in vacuum"],
    equipment:"Light blaster pistol, TIE flight suit (sealed, limited life support), Imperial comlink",
    desc:"Standard Imperial TIE pilots: competent, expendable, and utterly convinced the Empire cannot lose. In groups they are a serious threat at the controls of a fighter.",
    hook:"Capturing a TIE pilot intact provides Imperial IFF codes valid for 24–48 hours and tactical knowledge of local patrol patterns.",
  },
  tie_ace:{
    name:"TIE Ace",type:"RIVAL",species:"Human",career:"Imperial Ace Pilot",
    brawn:2,agility:4,intellect:2,cunning:3,willpower:2,presence:2,
    soak:2,woundThreshold:12,
    defense:{ranged:0,melee:0},
    skills:[{name:"Gunnery",rank:2},{name:"Piloting (Space)",rank:2},{name:"Cool",rank:2},{name:"Vigilance",rank:2}],
    talents:[
      {name:"Skilled Jockey 2",desc:"Remove two setback dice from Piloting (Space) checks."},
      {name:"Full Throttle",desc:"Once per round may perform the Full Throttle action; Hard Piloting check to increase vehicle speed by 1."},
      {name:"Dead to Rights",desc:"When a starship they pilot performs a combat action, spend 2 advantages to ignore defense from 1 defense zone."},
    ],
    weapons:[
      {name:"Light Blaster Pistol",damage:"5",critical:4,range:"Medium",qualities:"Stun Setting"},
    ],
    abilities:["Evasive Maneuvers — once per round as a maneuver may force one attacker to upgrade their attack difficulty once","Sensory Augmentation — add boost to all Perception checks made while piloting"],
    equipment:"Light blaster pistol, TIE ace flight suit (sealed, sensory augmentation package), Imperial comlink, personal transponder",
    desc:"An Imperial ace — one of the rare TIE pilots who has both survived long enough and performed well enough to earn special recognition. More autonomous, more dangerous, and harder to predict than standard pilots.",
    hook:"TIE aces operate with more independence than standard pilots. They may deviate from orders if they see an opportunity — which means they can also be baited, outmanoeuvred, or turned.",
  },
  lazarus:{
